...
payTrace n1 n2 = do  
    ...
    callEndpoint @"pay" h1 PayParams { ppRecipient = pkh2, ppLovelace = n1 } 
    void $ Emulator.waitNSlots 1
    callEndpoint @"pay" h1 PayParams { ppRecipient = pkh2, ppLovelace = n2 } 
    void $ Emulator.waitNSlots 1
...
payTest3 :: IO ()
payTest3 = runEmulatorTraceIO $ payTrace 1000000 20000000000
